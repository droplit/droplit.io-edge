	...
	stateChanged(err, value, index) {
		if (err) {
			...
			this.onPropertiesChanged([
				{ localId: pinLocalId, index: index, member: 'switch', service: 'BinarySwitch', value: value },
				{ localId: pinLocalId, index: index, member: 'direction', service: 'GPIO', value: GPIOpins[index].direction() }
			]);
		}
	}
